...
$topics = $DB->query('SELECT * FROM f_topics WHERE id_cat = 4 ORDER BY date_creation DESC LIMIT '.$depart.','.$topicsParPage);
...
<div class="container">
   <a id="ahreff" href="accueil.php">Accueil</a> > Catégorie : Chasse & Pêche
   <div class="row"> 
...
<?php 
      ...
      for($i=1;$i<=$pagesTotales;$i++) {
         if($i == $pageCourante) {
            ...
            echo '<a href="chaspech.php?page='.$i.'">'.$i.'</a> ';
         }
      }
      ?>
