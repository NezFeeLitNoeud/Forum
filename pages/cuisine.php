...
$topics = $DB->query('SELECT * FROM f_topics WHERE id_cat = 2 ORDER BY date_creation DESC LIMIT '.$depart.','.$topicsParPage);
...
<div class="container">
   <a id="ahreff" href="accueil.php">Accueil</a> > Catégorie : Cuisine
   <div class="row"> 
