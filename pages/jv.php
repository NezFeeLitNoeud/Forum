...
$topics = $DB->query('SELECT * FROM f_topics WHERE id_cat = 1 ORDER BY date_creation DESC LIMIT '.$depart.','.$topicsParPage);
...
<div class="container">
   <a id="ahreff" href="accueil.php">Accueil</a> > Catégorie : Jeux-Vidéo
   <div class="row"> 
